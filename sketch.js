...
function setup() {
  ...
  shelf = new Ground(270,height-625,width-470,20);
...
function draw() 
{
 ...
 if(collide(fruit,bunny,80)==true)
 {
  ...
  // if condition, when the fruit collision is detected, then the bunny eat animation should play.
 // Check hints its provided there
